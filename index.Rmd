...
<div class="plain-infobox"> No. states w/ legislation introduced<br><span class="small-big-num">`r sum(state_data$leg_intro > 0)`</span></div>

<div class="plain-infobox"> No. states w/ legislation passed <br><span class="small-big-num">`r sum(state_data$leg_passed > 0)`</span></div>
